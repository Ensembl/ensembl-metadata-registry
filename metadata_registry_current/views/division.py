...
from metadata_registry_current.api.division.filters import DivisionFilterBackend
...
class DivisionDatatableViewCurrent(DataTableListApi):
    serializer_class = DivisionSerializer
    search_parameters = SchemaUtils.get_field_names(app_name='metadata_registry_current', model_name='division', exclude_pk=False)
    default_order_by = 2
    queryset = Division.objects.all()
