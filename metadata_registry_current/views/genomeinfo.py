...
from metadata_registry_current.api.genomeinfo.serializers import GenomeSerializer, GenomeAlignmentSerializer, \
...
from metadata_registry_current.api.genomeinfo.filters import GenomeFilterBackend, GenomeComparaFilterBackend, GenomeVariationFilterBackend,\
...
from metadata_registry_current.api.organism.filters import OrganismAliasOrganismFilterBackend
...
class GenomeDatatableViewCurrent(DataTableListApi):
    serializer_class = GenomeSerializer
    search_parameters = SchemaUtils.get_field_names(app_name='metadata_registry_current', model_name='genome', exclude_pk=False)
    default_order_by = 1
