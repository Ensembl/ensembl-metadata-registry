...
from metadata_registry_current.models.assembly import Assembly, AssemblySequence
from metadata_registry_current.api.assembly.serializers import AssemblySerializer, AssemblySequenceSerializer
from rest_framework import generics
from metadata_registry_current.api.assembly.filters import AssemblyFilterBackend, AssemblySequenceFilterBackend,\
...
class AssemblyDatatableViewCurrent(DataTableListApi):
    serializer_class = AssemblySerializer
    search_parameters = SchemaUtils.get_field_names(app_name='metadata_registry_current', model_name='assembly', exclude_pk=False)
    default_order_by = 3
    queryset = Assembly.objects.all()
