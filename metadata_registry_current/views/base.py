...
from metadata_registry_current.utils.pagination import DataTablePagination
...
def datatable_view_current(request, table_name):
    ...
    return render(request, 'metadata_registry_current/datatable_view.html', {'table_name': table_name,
                                                                     'server_side_processing': server_side_processing,
                                                                     'data_fields': data_fields})


def datatable_fetch_current(request, table_name):
