...
import metadata_registry_current.views.genomeinfo as views
from metadata_registry_current.utils.datarelease import DataReleaseUtils
...
urlpatterns = [
    ...
    url(r'^info/division/(?P<division>[\w]+)/release/' + str(DataReleaseUtils.get_latest_ensembl_version()),
        TemplateView.as_view(template_name="metadata_registry_current/genomeinfo/datatable_ens.html"), name="genomeinfo_ens_table"),
    url(r'^info/division/(?P<division>[\w]+)/release/' + str(DataReleaseUtils.get_latest_ensemblgenomes_version()),
        TemplateView.as_view(template_name="metadata_registry_current/genomeinfo/datatable_ens.html"), name="genomeinfo_eg_table"),
