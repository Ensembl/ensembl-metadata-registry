...
from metadata_registry.api.genomeinfo.serializers import GenomeSerializer, GenomeAlignmentSerializer, \
...
from metadata_registry.api.genomeinfo.filters import GenomeFilterBackend, GenomeComparaFilterBackend, GenomeVariationFilterBackend,\
...
from metadata_registry.api.organism.filters import OrganismAliasOrganismFilterBackend
...
class GenomeDatatableView(DataTableListApi):
    serializer_class = GenomeSerializer
    search_parameters = SchemaUtils.get_field_names(app_name='metadata_registry', model_name='genome', exclude_pk=False)
    default_order_by = 1
